...
// IDENTIDADE + OU - CHAVE PRIMÁRIA
		...
		atm.retirar(420);
		System.out.println(atm.consultarQuantidade(5) == 0);
		System.out.println(atm.consultarQuantidade(10) == 0);
		System.out.println(atm.consultarQuantidade(50) == 0);
		System.out.println(atm.consultarValor() == 0);
		...
		System.out.println(atm.consultarQuantidade(20) == 2);
		System.out.println(atm.consultarQuantidade(50) == 2);
		System.out.println(atm.consultarQuantidade(100) == 2);

		System.out.println(atm.consultarValor() == 360);
		...
		System.out.println(atm.consultarValor() == 370);
