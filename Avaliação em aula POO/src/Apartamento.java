class Apartamento extends SuperLocacao{

	Apartamento(String endereco, int quartos, int garagem, double valor, double valorCondominio) {
	...
	double pagar(int n) {
		...
		if (this.getPrazo() >=  1){
			...
			return x + (x * 0.03) + (x * 0.10) + (x * (0.01 * n));
		}
		return 0;
	}
