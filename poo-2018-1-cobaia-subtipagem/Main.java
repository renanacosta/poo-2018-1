class Main {
  public static void main(String[] args) {
    ...
    Locacao loc1 = new Locacao('R', "Rua Alfredo Huch, 475", 2, 1, 900.0, 0.0);
    // constantes/imutáveis
    System.out.println(loc1.tipo); // R; // Casa (residencial)
    ...
    Locacao loc2 = new Locacao('A', "Av 24 de maio, 355", 1, 1, 400.0, 400.0);
    // constantes/imutáveis
    System.out.println(loc2.tipo); // A; // Apartamento
    ...
    Locacao loc3 = new Locacao('C', "Aquidaban, 8350", 0, 0, 1000.0, 500.0);
    // constantes/imutáveis
    System.out.println(loc3.tipo); // C; // Comercial
